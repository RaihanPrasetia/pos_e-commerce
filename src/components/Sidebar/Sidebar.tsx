...
export default function Sidebar({ isOpen, toggleSidebar }: SidebarProps) {
    ...
    return (
        <div className="bg-white relative lg:block sm:hidden shadow-mui-customShadow text-gray-700 border-r rounded-r-xl h-full flex flex-col transition-all duration-300 ease-in-out">
            ...
            <div className="py-4 text-base font-bold tracking-wide text-center flex items-center justify-center space-x-4 scroll-smooth">
                {isOpen ? (
                    <>
                        <Image
            ...
            <div className={` overflow-hidden max-h-[380px] shadow-inner py-2 ${isOpen ? "overflow-y-scroll " : "overflow-y-hidden"}`}>
            ...
            {isOpen && (
                <div className="py-2 px-4">
                    <div className="shadow-mui-customShadow rounded-md p-4 mt-4 overflow-hidden w-full bg-utama">
                        <div className='flex justify-between'>
                            <div className='w-full flex flex-col justify-between'>
                                <span className='text-white text-lg font-semibold' >Upgrade to premium</span>
                                <span className='text-white text-sm'>Upgrade customer to premium membership to access pro features.</span>
                            </div>
                        </div>

                        <button
                            className='bg-white mt-4 rounded-md w-full text-center py-1 cursor-pointer'
                        >
                            <span className='text-utama font-bold text-sm'>Upgrade To Premium</span>
                        </button>
                    </div>
                </div>
            )}
