      ...
      <div className="card-body">
        <table className="min-w-full bg-gray-50">
          <thead>
            ...
            <th className="py-2 px-4 text-left text-sm font-semibold text-gray-400">Action</th>
          </tr>

          </thead>
          <tbody>
            {sortedProducts.slice(0, pagination).map((product) => (
              <tr key={product.id} className="border-t">
                ...
                <td className="py-2 px-4 text-sm text-gray-500">{product.category}</td>
                <td className="py-2 px-4 text-sm text-gray-500">{product.price}</td>
                <td className="py-2 px-4 text-sm text-gray-500">{product.code}</td>
                <td className="py-2 px-4 text-sm text-gray-500">{product.qty}</td>
                <td className="py-2 px-4 text-sm text-gray-500">{product.status}</td>
